...
public class User {
    ...
    private List<MathFunction> functions = new ArrayList<>();
    ...
    public List<MathFunction> getFunctions() { return functions; }
    public void setFunctions(List<MathFunction> functions) { this.functions = functions; }
